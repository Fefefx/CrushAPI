...
Após esses preparos, instale as dependências com o comando *npm install*  e em seguida execute o comando *npm start* para subir o servidor express na porta 3000. Você pode visualizar as rotas no arquivo server/app.ts e testá-las usando uma ferramenta como [Postman](https://www.postman.com/ "Postman").
